...
export function createIdentityRouter(controllers: {
  ...
  requestEnrollment?:RequestHandler; completeEnrollment?:RequestHandler; login?:RequestHandler; bootstrap?:RequestHandler; refresh?:RequestHandler; current?:RequestHandler; replacePassword?:RequestHandler; logout?:RequestHandler;
}): Router {
  const router = Router();
