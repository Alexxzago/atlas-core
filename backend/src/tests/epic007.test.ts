...
test("fresh database receives all migrations and the default workspace", () => {
  ...
  assert.deepEqual(migrations.map(({ id, name }) => ({ id, name })), [
    ...
    { id: 11, name: "0011_platform_bootstrap" },
    { id: 12, name: "0012_operational_assistant_runtime" },
    { id: 13, name: "0013_conversation_domain_foundation" },
    { id: 14, name: "0014_conversation_execution_record_link" },
    { id: 15, name: "0015_web_chat_connections" },
    { id: 16, name: "0016_web_chat_sessions" },
    { id: 17, name: "0017_conversation_channel_metadata" },
    ...
    { id: 35, name: "0035_whatsapp_validation_failure_codes" },
    { id: 36, name: "0036_platform_administrators" },
    { id: 37, name: "0037_commercial_controls" },
    { id: 38, name: "0038_assistant_capability_foundation" },
    { id: 39, name: "0039_conversation_intelligence" },
    { id: 40, name: "0040_integration_connections_core" },
    { id: 41, name: "0041_live_data_observations" },
    { id: 42, name: "0042_live_data_observation_trace_link" },
  ]);
