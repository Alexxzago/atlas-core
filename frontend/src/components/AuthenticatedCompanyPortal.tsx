...
function AuthenticatedCompanyPortalContent({ csrf, userId, email, isPlatformAdmin, onPassword, onLogout }: Props): React.JSX.Element {
  ...
  const assistantSection=route.name==="company-assistant-section"&&(route.section==="general"||route.section==="behavior"||route.section==="capabilities"||route.section==="tools")?route.section:undefined;
