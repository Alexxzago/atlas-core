...
export function AuthLayout({ children }: { readonly children: ReactNode }): React.JSX.Element {
  ...
  return (
    <main className="auth-layout" id="main-content">
      <AtlasAtmosphere />
      <header className="auth-layout__header"><a aria-label="Atlas" className="auth-layout__brand" href="/"><AtlasGlyph size={24} /><strong>ATLAS</strong><span>{t("app.portal")}</span></a><ThemeSelector /></header>
