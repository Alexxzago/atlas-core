...
export class PermissionPolicy{
  public derive(role:MembershipRole):PermissionSet{const read:Permission[]=["workspace:read","company:read","knowledge:read"];const operator:Permission[]=[...read,"company:manage","onboarding:run","chat:use","conversation:message:send","assistant:preview","knowledge:ingest"];const administrator:Permission[]=[...operator,"workspace:manage","knowledge:publish","knowledge:archive","membership:list","membership:invite","membership:manage"];const values:Permission[]=role==="owner"?[...administrator,"administrator:manage","owner:manage","owner:transfer"]:role==="administrator"?administrator:role==="operator"?operator:role==="viewer"?read:[];return new ImmutablePermissionSet(values);}
