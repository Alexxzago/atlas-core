import type { EmbeddedSignupAttemptResponse, EmbeddedSignupStatusResponse, AssistantPreviewResponse, AssistantProfile, AssistantProfileStatus, AssistantReadinessAssessment, CommercialControlAuditEvent, ConversationControlResponse, ConversationDetail, ConversationFeedResponse, ConversationInboxItem, DefaultAssistantAssignment, ChatResponse, Company, CompanyInput, CompanyKnowledge, CompanyUpdate, CreatedWorkspace, CreateAssistantProfileInput, CreateWhatsAppConnectionInput, UpdateWhatsAppConnectionInput, UpdateWhatsAppVoicePolicyInput, KnowledgeIngestionResponse, KnowledgePublication, KnowledgeRevision, KnowledgeSource, OnboardingCompanyResponse, OnboardingResponse, OperationalAssistantExecutionResponse, OperatorConversationMessageResult, PlatformOverview, PlatformUserCommercialControls, PlatformUsersPage, PlatformWorkspaceCommercialControls, PlatformWorkspacesPage, RegistrationInput, SessionBootstrapResponse, UpdateAssistantProfileInput, VerificationResponse, VoiceMessageReadModel, WebChatConnection, WebChatConnectionStatus, WhatsAppConnection, WhatsAppConnectionOperationalStatus, WhatsAppVoicePolicy, WorkspaceCommercialStatus, WorkspaceSummary } from "../types/api";
