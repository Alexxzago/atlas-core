...
export const MEDIA_TYPES = Object.freeze(["application/pdf", "image/jpeg", "image/png", "image/gif", "image/webp"] as const);
export class MediaDomainError extends Error { public constructor(public readonly code: string) { super(code); } }

export function mediaKind(mediaType: string): MediaKind { return mediaType === "application/pdf" ? "document" : "image"; }
