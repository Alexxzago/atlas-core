...
function safeMessage(code:string):string{return({knowledge_unavailable:"Published Company Knowledge was not found.",knowledge_conflict:"Knowledge contains conflicts.",knowledge_publication_changed:"Published Company Knowledge changed.",knowledge_source_name_conflict:"A Knowledge source with this name already exists. Create a revision on that source instead.",knowledge_input_too_large:"Knowledge input is too large.",unsupported_pdf:"PDF is not supported.",pdf_text_empty:"PDF contains no usable text.",invalid_public_url:"Public URL is invalid."} as Record<string,string>)[code]??"Company Knowledge request could not be completed.";}
