...
const publicWebChatSessionService = new PublicWebChatSessionService(webChatConnectionService, conversationService, webChatPersistence.sessions, identityClock);
